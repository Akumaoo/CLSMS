...
else
{
	$rid=$_POST['rid'];
	echo json_encode(
	SSP::complex( $_POST, $sql_details, $table, $primary_key, $columns,null,"Status='OnGoing' AND (Subscription_Date BETWEEN LEFT('".$rid."',4) AND RIGHT('".$rid."',4)) AND DistributorName='".$dept."' AND Remove IS NULL AND arc is NULL" ));
}
