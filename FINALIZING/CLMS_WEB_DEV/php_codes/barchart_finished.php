  <?php
	...
	Function ongoingtotalf()
	{
		...
		$sqltxt1="Select Count(*) CountB From Subscription where Subscription.Status ='Finished' AND Archive IS NULL And Remove IS NULL AND Subscription_Date Between CONCAT(DATEPART(YYYY,GETDATE()),'-08-01') AND DATEADD(YEAR,1,CONCAT(DATEPART(YYYY,GETDATE()),'-05-01'))";
