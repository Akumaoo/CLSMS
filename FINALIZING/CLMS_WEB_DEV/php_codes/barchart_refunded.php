  <?php
	...
	Function ongoingtotalr()
	{
		...
		$sqltxt1="Select Count(*) CountB From Subscription where Subscription.Status ='Refunded' AND Archive IS NULL And Remove IS NULL AND Subscription_Date Between ".$bet;
