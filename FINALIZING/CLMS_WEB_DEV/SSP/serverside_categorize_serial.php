...
(Select Category_Serials_Program.SubscriptionID,Program.ProgramID as Programs,NumberofItemsReceived_Prog,Organization.DepartmentID from Serial Inner Join Subscription On Serial.SerialID=Subscription.SerialID
...
Where SerialName='$sname') as dsa ON asd.DepartmentID=dsa.DepartmentID
) temp
EOT;
