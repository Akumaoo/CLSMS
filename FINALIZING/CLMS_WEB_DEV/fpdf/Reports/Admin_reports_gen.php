...
{	
	...
	function Header()
	{
	    ...
	    if($type_report=='OS')
	    {
	    	$this->Cell(203,6,'LIST OF ONGOING SUBSCRIPTIONS',0,1,'C');
	    }
	    else if ($type_report=='FS')
	    {
	    	$this->Cell(203,6,'LIST OF FULFILLED SUBSCRIPTIONS',0,1,'C');
	    }
	    else if($type_report=='RT')
	    {
	    	$this->Cell(203,6,'LIST OF RECEIVED TITLES',0,1,'C');
	    }
	    else if($type_report=='DT')
	    {
	    	$this->Cell(203,6,'LIST OF DELIVERED TITLES',0,1,'C');
	    }
	    else if ($type_report=='Subscriptions')
	    {
	    	$this->Cell(203,6,'LIST OF CURRENT SUBSCRIPTIONS',0,1,'C');
	    }
